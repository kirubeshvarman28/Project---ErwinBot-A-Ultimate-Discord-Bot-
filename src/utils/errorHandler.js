 ...
 * 
 * This module provides structured error handling for the ErwinBot application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw ErwinBotError for application-specific errors
...
export function categorizeError(error) {
    if (error instanceof ErwinBotError) {
        return error.type;
    }
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new ErwinBotError(message, type, userMessage, normalizedContext);
}
